...
<% 
    ...
    %>
    <p style="text-align:left; color:white; font-size:18px;"><b><%= year %>년 <%= month %>월 <%= day %>일</b>
  </p>
   </div>
<div>
<h1 style=" font-family: 'Pretendard-Regular'; text-align:center"> 상품 판매 </h1>
        ...
        <td>
            <p style="font-size: 20px; text-align: center; color: black; padding: 20px; background-color: white; border-radius: 5px; margin: 20px;">
                ...
                <form action="/cart/add" method="post">
                    ...
                    <input style="text-align:center;" type="submit" value="선택" onclick="clearCart()">
                </form>
        </td>
