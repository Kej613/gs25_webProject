...
<p style="text-align:right; color: blue;"><a style="text-align:right;color:blue;"href="/cart">상품관리</a></p>
...
<c:forEach var="item"  items="${snack_item}" varStatus="status">
<c:if test="${item.category eq '스낵'}">
